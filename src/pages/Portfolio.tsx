...
import portfolio_synergeast from '../porfolio/assets/portfolio-synergeast-id.png';


const Portfolio = () => {
    const projects = [
        {
            title: "AI Generated Event and Landing Page for Marketing and EO",
            category: "Entertainment",
            description: "Landing page with AI automatic generation.",
            image: portfolio_synergeast,
            technologies: ["Python", "TensorFlow", "React", "Node.js", "WebSocket"],
            results: ["Quick develop", "Quick launch", "More secure"],
    ...
    return (
        <div>
            <SEO
                title="Our Portfolio - Agantra Inovatif"
                description="Explore our portfolio of innovative AI solutions that have transformed businesses across industries."
            ...
            <section className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-12">
                        Explore our portfolio of innovative AI solutions that have transformed businesses across
                        industries.
                    </p>
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <span
                        className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-3 py-1 rounded-full text-sm font-semibold">
                      {project.category}
                    </span>
                                    </div>
                                </div>
